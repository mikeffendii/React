  ...
  return (
    <div id="container" class="container mt-5">
      ...
      <form id="form" autocomplete="off">
        ...
        <br/><br/>
        <label for="date2"> Today's Date:
          <input type="text" id="date2" placeholder="Date" />
          <input type="text" maxlength="2" size="2" id="month2" placeholder="Month" />
          <input type="text" id="year2" placeholder="Year" />
        </label>
        <br/><br/>
        <button id="calbtn" class="btn btn-primary">Age Calculate</button>
        <br/><br/>
        <span id="age"></span>
        <span id="months"></span>
        <span id="days"></span>
